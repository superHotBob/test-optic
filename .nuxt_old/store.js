...
void (function updateModules() {
  ...
  resolveStoreModules(require('@/store/basket/actions.js'), 'basket/actions.js')
  resolveStoreModules(require('@/store/basket/mutations.js'), 'basket/mutations.js')
  resolveStoreModules(require('@/store/basket/state.js'), 'basket/state.js')
  resolveStoreModules(require('@/store/catalog/actions.js'), 'catalog/actions.js')
  resolveStoreModules(require('@/store/catalog/getters.js'), 'catalog/getters.js')
  resolveStoreModules(require('@/store/catalog/mutations.js'), 'catalog/mutations.js')
  resolveStoreModules(require('@/store/catalog/state.js'), 'catalog/state.js')
  resolveStoreModules(require('@/store/basket/getters.js'), 'basket/getters.js')
