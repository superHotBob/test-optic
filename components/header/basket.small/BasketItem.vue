...
<div class="basket__item">
    <div class="basket__img">
        <img alt="" v-if="arItem.PREVIEW_PICTURE_SRC_ORIGINAL" v-lazy="arItem.PREVIEW_PICTURE_SRC_ORIGINAL">
            <template v-else-if="arItem.NAME == 'Ободковая' || arItem.NAME == 'Полуободковая' || arItem.NAME == 'Безободковая'">
                <img alt="" v-if="arItem.NAME == 'Ободковая'" src="~assets/images/card/workshop-obodkovaya.svg">
                <img alt="" v-if="arItem.NAME == 'Полуободковая'" src="~assets/images/card/workshop-poluobodkovaya.svg">
                <img alt="" v-if="arItem.NAME == 'Безободковая'" src="~assets/images/card/workshop-bezobodkovaya.svg">
            </template>
